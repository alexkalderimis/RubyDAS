...
class Feature
  ...
  property :start,       Number      # A text block, for longer string data.
  property :end,       Number      # A text block, for longer string data.
...
class Target
  ...
  property :id, Serial
  property :start,       Number      # A text block, for longer string data.
  property :stop,       Number      # A text block, for longer string data.
